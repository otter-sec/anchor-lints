...
pub mod arbitrary_cpi_call_tests {
    ...
    // This CPI validates the program id before invoking and should be considered safe.
    pub fn validated_cpi_2(ctx: Context<ValidatedCpi>, target_program_id: Pubkey, amount: u64) -> Result<()> {
        require_keys_eq!(
            target_program_id,
            system_program::ID,
            CustomError::InvalidProgram
    ...
    pub fn arbitrary_cpi_from_parameter(ctx: Context<BasicTransfer>, target_program_id: Pubkey, amount: u64) -> Result<()> {
        let cpi_accounts = Transfer {
            from: ctx.accounts.from.to_account_info(),
            to: ctx.accounts.to.to_account_info(),
        };
    ...
    pub fn validated_program_id(ctx: Context<BasicTransfer>, target_program_id: Pubkey, amount: u64) -> Result<()> {
        require!(
    ...
    pub fn program_id_from_account_data(ctx: Context<DataBasedTransfer>, amount: u64) -> Result<()> {
    ...
    pub fn program_id_from_hash(ctx: Context<BasicTransfer>, user_seed: Pubkey, amount: u64) -> Result<()> {
    ...
    pub fn allowlist_validation(ctx: Context<BasicTransfer>, target_program_id: Pubkey, amount: u64) -> Result<()> {
    ...
    pub fn program_id_from_pda(ctx: Context<BasicTransfer>, seed: Vec<u8>, amount: u64) -> Result<()> {
    ...
    pub fn conditional_validation_unsafe(ctx: Context<BasicTransfer>, target_program_id: Pubkey, amount: u64) -> Result<()> {
    ...
    pub fn validated_with_require_keys_eq(ctx: Context<BasicTransfer>, target_program_id: Pubkey, amount: u64) -> Result<()> {
    ...
    pub fn direct_invoke_signed_with_system_transfer(ctx: Context<DirectInvokeTransfer>, amount: u64) -> Result<()> {
    ...
    pub fn direct_invoke_signed_with_arbitrary_instruction(ctx: Context<DirectInvokeTransfer>, amount: u64) -> Result<()> {
        use anchor_lang::solana_program::program::invoke_signed;
    ...
    pub fn cpi_builder_with_validated_account(ctx: Context<CpiBuilderAccounts>, amount: u64) -> Result<()> {
    ...
    pub fn cpi_builder_with_unchecked_account(ctx: Context<CpiBuilderUnchecked>, amount: u64) -> Result<()> {
        let cpi_accounts = Transfer {
            from: ctx.accounts.from.to_account_info(),
            to: ctx.accounts.to.to_account_info(),
        };
    ...
    pub fn conditional_token_program_safe(ctx: Context<ConditionalTokenProgram>, amount: u64) -> Result<()> {
    ...
    pub fn direct_invoke_signed_hardcoded(ctx: Context<DirectInvokeTransfer>, amount: u64) -> Result<()> {
        use anchor_lang::solana_program::program::invoke_signed;
        use anchor_lang::solana_program::system_instruction::transfer;
    ...
    pub fn direct_invoke_signed_from_account_data(ctx: Context<DirectInvokeFromData>, amount: u64) -> Result<()> {
        use anchor_lang::solana_program::program::invoke_signed;
        use anchor_lang::solana_program::instruction::Instruction;
    ...
    pub fn cpi_with_pda_derived_program(ctx: Context<PdaDerivedProgram>, amount: u64) -> Result<()> {
    ...
    pub fn cpi_with_whitelist_validation(ctx: Context<WhitelistValidation>, amount: u64) -> Result<()> {
        const ALLOWED_PROGRAMS: [Pubkey; 2] = [
            system_program::ID,
            anchor_spl::token::ID,
        ];
    ...
    pub fn nested_cpi_with_validation(ctx: Context<NestedCpiAccounts>, amount: u64) -> Result<()> {
        ...
        let nested_cpi_ctx = CpiContext::new(
            ctx.accounts.target_program.key(),
            nested_cpi_accounts,
        );
